        ...
        <div className="wizard-fieldset">
          ...
          <fieldset className={`second-field ${activeTab === 2 ? 'd-block' : 'd-none'}`}>
            ...
            <div className="modal-footer d-flex align-items-center justify-content-between">
              <Link href="#" onClick={()=>{setActiveTab(1); setCompletedTab(0)}} className="btn btn-light prev_btn">
          ...
          <fieldset className={activeTab === 3 ? 'd-block' : 'd-none'}>
            ...
            <div className="modal-footer d-flex align-items-center justify-content-between">
              <Link href="#" onClick={()=>{setActiveTab(2); setCompletedTab(0)}} className="btn btn-light prev_btn">
                <i className="ti ti-arrow-left me-2" />
                Back
              </Link>
              <Link
          ...
          <fieldset className={activeTab === 4 ? 'd-block' : 'd-none'}>
            ...
            <div className="modal-footer d-flex align-items-center justify-content-between">
              <Link href="#" onClick={()=>{setActiveTab(3);setCompletedTab(1)}} className="btn btn-light prev_btn">
                <i className="ti ti-arrow-left me-2" />
                Back
              </Link>
              <Link
