  ...
  <div className="container">
    ...
    <ul className="nav nav-tabs nav-tabs-solid justify-content-center mb-4">
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-removals" data-bs-toggle="tab">
          Removals
        </Link>
      </li>
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-furniture" data-bs-toggle="tab">
          Furniture Assembly
        </Link>
      </li>
      <li className="nav-item mb-3">
      ...
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-construction" data-bs-toggle="tab">
          Construction
        </Link>
      </li>
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-man" data-bs-toggle="tab">
          Man &amp; Van
        </Link>
      </li>
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-plumbing" data-bs-toggle="tab">
          Plumbing
        </Link>
      </li>
      <li className="nav-item mb-3">
        <Link className="nav-link" href="#rate-more" data-bs-toggle="tab">
          More Services
        </Link>
      </li>
    </ul>
      ...
      <div className="tab-pane fade" id="rate-removals">
        <div className="row g-4">
          <div className="col-md-6 col-lg-3">
            <Link href={routes.serviceDetails1} className="rated-wrap">
              <ImageWithBasePath
    ...
    <div className="text-center view-all wow fadeInUp" data-wow-delay="0.2s">
      <Link href={routes.serviceGrid} className="btn btn-dark">
        View All
