      ...
      <section className="section popular-section">
        <div className="container">
          ...
          <ul className="nav nav-tabs nav-tabs-solid justify-content-center mb-4">
            ...
            <li className="nav-item mb-3">
              <Link className="nav-link" href="#removals" data-bs-toggle="tab">
                Removals
              </Link>
            </li>
            <li className="nav-item mb-3">
              <Link className="nav-link" href="#man" data-bs-toggle="tab">
                Man &amp; Van
              </Link>
            </li>
            <li className="nav-item mb-3">
              <Link className="nav-link" href="#furniture" data-bs-toggle="tab">
                Furniture Assembly
              </Link>
            </li>
            <li className="nav-item mb-3">
              <Link className="nav-link" href="#electrical" data-bs-toggle="tab">
                Electrical
              </Link>
            </li>
            <li className="nav-item mb-3">
            ...
            <li className="nav-item mb-3">
              <Link className="nav-link" href="#plumbing" data-bs-toggle="tab">
                Plumbing
              </Link>
            </li>
            <li className="nav-item mb-3">
                  ...
                  return (
                    ...
                    >
                          ...
                          {res.Slider.map((img: any, index: number) => {
                            return (
                              <div className="slide-images" key={index}>
                                <Link href={routes.serviceDetails1}>
                                  <ImageWithBasePath
                      ...
                      <div className="service-content">
                        ...
                        <Link href={routes.serviceDetails1}>{res.Title}</Link>
                        </h6>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="text-center wow fadeInUp" data-wow-delay="0.2s">
                <Link href={routes.search} className="btn btn-dark">
                  View All
