    ...
    <div className="container">
      <div className="provider-sec">
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Hendry Thompson</Link>
                  </h6>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>William Patterson</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.8 (200 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Lorenzo Verduzco</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.6 (270 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Rafael Smith</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.8 (300 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Robert Boyd</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.8 (300 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Joe Fletcher</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.9 (370 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>Benjamin Wade</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.2 (220 Reviews)
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 d-flex">
            <div className="provider-item flex-fill">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6>
                    <Link href={routes.providerDetails}>William Hughes</Link>
                  </h6>
                  <p className="fs-14 mb-0">
                    <i className="ti ti-star-filled text-warning me-1" />
                    4.3 (280 Reviews)
        ...
        <div
          ...
          data-wow-delay="0.2s"
        >
          <Link href={routes.providersList} className="btn btn-dark">
            View All
