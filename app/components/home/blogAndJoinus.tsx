  ...
  <section className="section service-section white-section blog-section">
    <div className="container">
      ...
      <Slider {...imgslideroption} className="service-slider owl-carousel nav-center nav-center">
        <div className="blog-item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div className="blog-content">
            ...
            <h6 className="text-truncate mb-2">
              <Link href={routes.blogDetails}>Bill Walsh leadership lessons</Link>
            </h6>
        ...
        <div className="blog-item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div className="blog-content">
            ...
            <h6 className="text-truncate mb-2">
              <Link href={routes.blogDetails}>Transform Your Space</Link>
            </h6>
            <p className="two-line-ellipsis mb-3">
        ...
        <div className="blog-item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div className="blog-content">
            ...
            <h6 className="text-truncate mb-2">
              <Link href={routes.blogDetails}>Top Tips for Service Success</Link>
            </h6>
            <p className="two-line-ellipsis mb-3">
        ...
        <div className="blog-item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div className="blog-content">
            ...
            <h6 className="text-truncate mb-2">
              <Link href={routes.blogDetails}>Service Innovations</Link>
            </h6>
            <p className="two-line-ellipsis mb-3">
        ...
        <div className="blog-item wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div className="blog-content">
            ...
            <h6 className="text-truncate mb-2">
              <Link href={routes.blogDetails}>Revamp Your Home</Link>
            </h6>
            <p className="two-line-ellipsis mb-3">
      ...
      <div className="text-center wow fadeInUp" data-wow-delay="0.2s">
        <Link href={routes.blogGrid} className="btn btn-dark">
          View All
